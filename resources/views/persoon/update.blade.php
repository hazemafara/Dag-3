...
<body>
    ...
    <div class="form-container">
        <form action="{{ route('persoon.update', ['id' => $klant->id]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <input type="checkbox" id="is_vertegenwoordiger" name="is_vertegenwoordiger"
                {{ $klant->is_vertegenwoordiger ? 'checked' : '' }}>

            <!-- Contactgegevens -->
            <label for="contact_street">Straat:</label>
            <input type="text" id="contact_street" name="contact_street" value="{{ $klant->contact_street }}"
                required>
            ...
            <input type="text" id="contact_mobile" name="contact_mobile" value="{{ $klant->contact_mobile }}"
                required>
