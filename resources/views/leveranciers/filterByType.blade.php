                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($leverancier->producten && $leverancier->producten->count() > 0)
                                        @foreach($leverancier->producten->sortBy('product_naam') as $product)
                                            <a href="{{ route('productperleverancier.edit', ['leverancierId' => $leverancier->id, 'productId' => $product->id]) }}" class="btn btn-primary">
